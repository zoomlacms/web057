...
<div class="mainpay_div container">
    ...
    <div class="alert alert-info" runat="server" id="payinfo_div">
        <div class="h4"><strong>订单提交成功，请您尽快付款!</strong></div>
        <p>
        	订单号：<asp:Label ID="OrderNo_L" runat="server"></asp:Label>
        	应付金额：<asp:Label ID="LblPayMoney" runat="server" CssClass="r_red"></asp:Label><br/>
            <asp:Label runat="server" ID="Fee" Text="帐户余额："></asp:Label><asp:Label ID="LblRate" CssClass="r_red" runat="server" Text="XX元"></asp:Label><br/>
            支付方式：<asp:Label ID="VMoneyPayed_L" runat="server" CssClass="r_orange"></asp:Label> <a href="/PayOnline/Orderpay.aspx?PayNo=<%:PayNo %>" class="btn btn-warning btn-xs">重新选择</a><br/>
        </p>
        <div class="margin_t10" runat="server" visible="false" id="Alipay_Btn">
            <button type="button" class="btn btn-info" onclick="alipaySubmit();">确定付款</button>
        </div>
